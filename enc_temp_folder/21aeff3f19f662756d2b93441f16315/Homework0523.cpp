...
void TestFunction(Player _Newplayer, int _Test)
{
    ...
    __int64 Address1 = (__int64)&_Newplayer.HP; //2030380
    __int64 Address2 = (__int64)&_Newplayer.Speed; //2030384
    __int64 Address3 = (__int64)&_Newplayer.ATT; //2030388
    __int64 Address4 = (__int64)&_Test; //2030396
    // 이것도 확인해보세요.
    int a = 0;
}
